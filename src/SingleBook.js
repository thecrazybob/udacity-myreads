            ...
            <li>
                <div className="book">
                  <div className="book-top">
                    ...
                    <SingleBookShelfChanger book={this.props.book} categories={this.props.categories} onUpdate={this.changeBookShelf}/>
                  </div>
                  <SingleBookInfo bookName={this.props.book.title} bookAuthors={this.props.book.authors} />
                </div>
            </li>
        )
    }
